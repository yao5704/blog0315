...
# class UsermesForm(forms.ModelForm):
#     class Meta:
#         model = Profile
#         fields = ['nickname','logo','telephone']
...
class ChangeUserForm(forms.Form):
    ...
    logo_new = forms.CharField(label='新的个性签名',
                               max_length=20,
                               widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': '请输入新的个性签名'}),
                               required=False,)

    tel_new = forms.CharField(label='新的电话号码',
                              max_length=20,
                              widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': '请输入新的电话号码'}),
                              required=False,)
